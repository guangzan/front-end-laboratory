    ...
    37827: function (t, e, n) {
      ...
      function w(t) {
        var e =
          ...
          r = e;
        function a() {
          (r -= 1), r <= 0 ? (t(), delete C[n]) : (C[n] = (0, x.Z)(a));
        }
        return (C[n] = (0, x.Z)(a)), n;
      }
      (w.cancel = function (t) {
        void 0 !== t && (x.Z.cancel(C[t]), delete C[t]);
      }),
        (w.ids = C);
      var T,
        O = n(96159);
          ...
          return (
            ...
            (t.onClick = function (e, n) {
              ...
              if (!(!e || S(e) || e.className.indexOf('-leave') >= 0)) {
                ...
                var i = (0, b.Z)(t),
                  c = i.extraNode,
                  s = t.context.getPrefixCls;
                c.className = ''.concat(s(''), '-click-animating-node');
                var l = t.getAttributeName();
                if (
            ...
            (t.renderWave = function (e) {
              ...
              return (
                (0, k.Yr)(r) && (a = (0, k.sQ)(r.ref, t.containerRef)),
                (0, O.Tm)(r, { ref: a })
              );
            }),
            t
      ...
      var Y = function (t, e) {
          var n,
            ...
            q = c.useRef(),
            K = function () {
              return 1 === c.Children.count(E) && !Z && !F(v);
            },
            X = function () {
              if (Y && Y.current && !1 !== H) {
          ...
          (s = 'object' === (0, i.Z)(m) && m.delay ? m.delay || !0 : !!m),
            c.useEffect(
              function () {
          ...
          var at = L ? 'loading' : Z,
            ot = l()(
              ...
              (0, a.Z)(n, ''.concat(et, '-background-ghost'), x && !F(v)),
          ...
          if (void 0 !== st.href)
            return c.createElement(
              'a',
              (0, r.Z)({}, st, { className: ot, onClick: tt, ref: Y }),
              it,
              ct,
            );
          var lt = c.createElement(
            'button',
            (0, r.Z)({}, O, { type: T, className: ot, onClick: tt, ref: Y }),
            it,
            ct,
          );
          return F(v) ? lt : c.createElement(P, null, lt);
        },
        q = c.forwardRef(Y);
